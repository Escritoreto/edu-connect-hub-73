      ...
      <div className="container relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background/10 backdrop-blur-sm border border-primary-foreground/20">
              ...
              <span className="text-sm font-medium text-primary-foreground">
                Sua jornada global começa aqui
              </span>
            </div>
            
            <h1 className="text-4xl lg:text-6xl font-bold text-primary-foreground leading-tight">
              Transforme Seu Futuro com Educação Global
            </h1>
            
            <p className="text-lg text-primary-foreground/90 leading-relaxed">
              Encontre bolsas de estudo internacionais, aprenda com cursos online certificados e construa um currículo profissional que abre portas para o mundo.
            </p>
          ...
          <div className="relative lg:block hidden animate-fade-in">
            ...
            <div className="absolute -bottom-4 -left-4 bg-background rounded-xl p-4 shadow-card animate-bounce-subtle" style={{ animationDelay: "1s" }}>
