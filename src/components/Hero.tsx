      ...
      <div className="container relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            ...
            <h1 className="sm:text-4xl lg:text-6xl text-primary-foreground leading-tight font-semibold font-sans mx-0 my-0 px-0 py-0 pb-[20px] pr-[20px] text-xl text-justify">Transforme seu futuro com UpMentor</h1>
