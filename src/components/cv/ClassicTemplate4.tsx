...
export const ClassicTemplate4 = ({ data }: Props) => {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-white text-gray-900 w-[210mm] h-[297mm] mx-auto shadow-xl print:shadow-none p-12 flex flex-col" id="cv-preview">
