...
export const ClassicTemplate4 = ({ data }: Props) => {
  ...
  return (
    <div className="bg-white text-gray-900 w-[210mm] min-h-[297mm] mx-auto shadow-xl p-12" id="cv-preview">
      {/* Header */}
      <div className="text-center border-b-4 border-purple-800 pb-6 mb-8">
      ...
      {data.summary && (
        <div className="mb-8">
          <h2 className="text-2xl font-serif font-bold text-purple-800 mb-3 uppercase tracking-wide">
            Resumo Profissional
          </h2>
      ...
      {data.jobTitle && data.company && (
        <div className="mb-8">
          <h2 className="text-2xl font-serif font-bold text-purple-800 mb-4 uppercase tracking-wide">
          ...
          <div className="grid grid-cols-2 gap-3">
            {skills.map((skill, index) => (
              <div key={index} className="flex items-center">
                <span className="w-2 h-2 bg-purple-800 rounded-full mr-3"></span>
