...
export const ClassicTemplate = ({ data }: Props) => {
  ...
  return (
    <div className="bg-white text-gray-900 w-[210mm] min-h-[297mm] mx-auto shadow-xl print:shadow-none p-10 flex flex-col" id="cv-preview">
      ...
      {data.summary && (
        <div className="mb-5">
          <h2 className="text-xl font-serif font-bold text-gray-800 mb-2 uppercase tracking-wide">
            Resumo Profissional
          </h2>
      ...
      {data.experience.length > 0 && (
        <div className="mb-5">
          <h2 className="text-xl font-serif font-bold text-gray-800 mb-3 uppercase tracking-wide">
