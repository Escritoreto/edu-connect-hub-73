...
export const ClassicTemplate = ({ data }: Props) => {
  ...
  return (
    <div className="bg-white text-gray-900 w-[210mm] h-[297mm] mx-auto shadow-xl print:shadow-none p-12 flex flex-col" id="cv-preview">
      ...
      {data.summary && (
        <div className="mb-8">
          <h2 className="text-2xl font-serif font-bold text-gray-800 mb-3 uppercase tracking-wide">
            Resumo Profissional
          </h2>
      ...
      {data.experience.length > 0 && (
        <div className="mb-8">
          <h2 className="text-2xl font-serif font-bold text-gray-800 mb-4 uppercase tracking-wide">
      ...
      {data.education.length > 0 && (
        <div className="mb-8">
          ...
          <div className="border-l-4 border-gray-300 pl-6 space-y-4">
