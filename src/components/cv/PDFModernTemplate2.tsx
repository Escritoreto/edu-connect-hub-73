              ...
              <View style={styles.section}>
                ...
                {data.certifications.map((cert) => (
                  <View key={cert.id} style={{ marginBottom: 6 }}>
                    <Text style={{ fontSize: 9, fontWeight: 700, color: "#1e293b" }}>{cert.name}</Text>
                    <Text style={{ fontSize: 8, color: "#64748b" }}>{cert.institution}</Text>
                  </View>
                ))}
              </View>
            )}
              ...
              <View style={styles.section}>
                ...
                {data.projects.map((proj) => (
                  <View key={proj.id} style={{ marginBottom: 6 }}>
                    <Text style={{ fontSize: 9, fontWeight: 700, color: "#1e293b" }}>{proj.name}</Text>
                    {proj.description && (
                      <Text style={{ fontSize: 8, color: "#475569" }}>{proj.description}</Text>
                    )}
                  </View>
                ))}
              </View>
