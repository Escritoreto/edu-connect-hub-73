  ...
  return (
    <div className="bg-white text-gray-900 w-[210mm] min-h-[297mm] mx-auto shadow-xl p-16" id="cv-preview">
      ...
      <div className="mb-12">
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            ...
            {data.jobTitle && (
              <p className="text-lg text-blue-600 font-light tracking-wide uppercase">
                {data.jobTitle}
              </p>
            )}
          </div>
        ...
        <div className="h-px bg-blue-300 my-6"></div>
      ...
      {data.jobTitle && data.company && (
        <div className="mb-10">
          <h2 className="text-xl font-bold text-blue-900 uppercase tracking-widest mb-6">
            Experiência
          </h2>
          <div className="mb-6">
            ...
            <p className="text-blue-600 mb-3 font-light">{data.company}</p>
      ...
      {data.degree && data.institution && (
        <div className="mb-10">
          ...
          <p className="text-blue-600 font-light">{data.institution}</p>
        </div>
      )}
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            {skills.map((skill, index) => (
              <span 
                key={index} 
                className="px-4 py-2 border border-blue-300 text-blue-700 font-light text-sm"
              >
                {skill}
              </span>
            ))}
