...
export const ModernTemplate4 = ({ data }: Props) => {
  ...
  return (
    <div className="bg-white text-gray-900 w-[210mm] h-[297mm] mx-auto shadow-xl print:shadow-none flex" id="cv-preview">
      {/* Left Sidebar */}
      <div className="w-2/5 bg-gradient-to-b from-orange-600 to-orange-800 text-white p-6 flex flex-col">
        {/* Photo */}
        {data.photoPreview && (
          <div className="mb-5">
            <img 
      ...
      <div className="flex-1 p-6 flex flex-col">
        ...
        <div className="pb-4 border-b-2 border-orange-200">
          <h1 className="text-4xl font-bold text-orange-800 mb-1">
            {data.firstName} {data.lastName}
          </h1>
          {firstJob && (
            <p className="text-xl text-orange-600">{firstJob.jobTitle}</p>
          )}
        </div>
        ...
        {data.summary && (
          <div className="mt-4">
            <h2 className="text-xl font-bold text-orange-800 mb-1 border-b-2 border-orange-200 pb-1">
              Sobre Mim
            </h2>
        ...
        {data.experience.length > 0 && (
          <div className="mt-4">
            <h2 className="text-xl font-bold text-orange-800 mb-2 border-b-2 border-orange-200 pb-1">
              Experiência
            </h2>
            ...
            <div className="space-y-2">
              {data.projects.map((proj) => (
                <div key={proj.id}>
                  ...
                  {proj.link && (
                    <p className="text-xs text-orange-600">{proj.link}</p>
                  )}
                </div>
              ))}
            </div>
