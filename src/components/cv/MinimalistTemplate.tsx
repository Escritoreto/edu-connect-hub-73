...
export const MinimalistTemplate = ({ data }: Props) => {
  ...
  return (
    <div className="bg-white text-gray-900 w-[210mm] h-[297mm] mx-auto shadow-xl p-16 overflow-hidden flex flex-col" id="cv-preview">
      {/* Header */}
      <div className="mb-12">
      ...
      {data.jobTitle && data.company && (
        <div className="mb-10">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 mb-3 font-light">{data.company}</p>
      ...
      {data.degree && data.institution && (
        <div className="mb-10">
          ...
          <p className="text-gray-600 font-light">{data.institution}</p>
        </div>
      )}
