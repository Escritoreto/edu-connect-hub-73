        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              {whatsapp &&
              <li>
                  <a href={getWhatsAppUrl(whatsapp)} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-background/60 hover:text-secondary transition-colors">
