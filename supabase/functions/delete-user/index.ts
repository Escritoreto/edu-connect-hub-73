...
Deno.serve(async (req) => {
  ...
  try {
    ...
    await supabaseAdmin.from("user_favorites").delete().eq("user_id", user_id);
    await supabaseAdmin.from("scholarship_requests").delete().eq("user_id", user_id);
    await supabaseAdmin.from("course_enrollments").delete().eq("user_id", user_id);
    await supabaseAdmin.from("publication_views").delete().eq("user_id", user_id);
